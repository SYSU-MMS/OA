...
Class WeeklyCheck extends CI_Controller
{
    ...
    public function index() {
        if (isset($_SESSION['user_id'])) {
            ...
            $classrooms[ $wid ] = $this->Moa_worker_model->get($wid)->week_classroom;
            ...
            for ($i = 0; $i < count($common_worker); $i++) {
                ...
                $classrooms[ $wid_list[ $i ] ] = $this->Moa_worker_model->get($wid_list[ $i ])->week_classroom;
    ...
    public function weeklyCheck() {
        if (isset($_SESSION['user_id'])) {
            ...
            $classrooms = $this->Moa_worker_model->get($check_wid)->week_classroom;
