                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content">
                                ...
                                <table class="table table-striped table-bordered table-hover users-dataTable">
                                    ...
                                    <tbody>
                                    	<?php for ($i = 0; $i < count($journallist); $i++) { ?>
	                                        <tr>
	                                        	<td><?php echo $i + 1; ?></td>
	                                            <td><?php echo $journallist[$i]->weekcount; ?></td>
	                                            <td><?php echo $journallist[$i]->weekday; ?></td>
	                                            <td><?php echo $journalname[$i]; ?></td>
	                                            <td><?php echo $journallist[$i]->timestamp; ?></td>
                                                <td>
                                                    <?php echo('<a href="' . site_url() . '/Journal/readJournalById/' . $journallist[$i]->lrid . '"><b>查看</b></a>'); ?>
                                                    <?php 
                                                        // 管理员和自己才有删除按钮
                                                        if ($_SESSION['level'] > 1 ||
                                                        ($_SESSION['name'] == $journalname[$i])) {
                                                            echo('&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;');
                                                            echo('<a href="' . site_url() . '/Journal/deleteJournalById/' . $journallist[$i]->lrid . '"><b>删除</b></a>');
                                                        }
                                                    ?>
                                                </td>
	                                        </tr>
