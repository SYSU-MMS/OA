                ...
                <nav class="navbar navbar-static-top" role="navigation">
                    ...
                    <div class="navbar-collapse collapse" id="navbar">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                <a aria-expanded="false" role="button" href="index_4.html#" class="dropdown-toggle" data-toggle="dropdown"> 菜单 <span class="caret"></span></a>
                            ...
                            <li class="dropdown">
                                ...
                                <ul role="menu" class="dropdown-menu">
                                    ...
                                    <li><a href="index_4.html">M菜单列表</a>
                                    </li>
                                </ul>
                            </li>
                            <li class="dropdown">
                                ...
                                <div class="ibox-title">
                                    ...
                                    <div class="ibox-tools">
                                        ...
                                        <ul class="dropdown-menu dropdown-user">
                                            <li><a href="index_4.html#">设置选项1</a>
                                            </li>
                                            <li><a href="index_4.html#">设置选项2</a>
                                            </li>
                                        </ul>
                                        <a class="close-link">
