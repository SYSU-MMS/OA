                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            ...
                            <div class="ibox-tools">
                                <a class="btn btn-primary btn-xs manager" onclick="new_last_week()">新建上周抽查记录表</a>
                                <a class="btn btn-primary btn-xs manager" onclick="new_this_week()">新建本周抽查记录表</a>
                                <a class="btn btn-primary btn-xs manager" onclick="new_n_week()">新建第n周抽查记录表</a>
